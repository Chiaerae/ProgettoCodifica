...
<xsl:stylesheet version="1.0"
    ...
    <xsl:template match="/tei:teiCorpus">
        <html>
            <head>
                ...
                <script src="javascript-due.js"></script>
            ...
            <body>
                ...
                <div id="immagineFacs">
                    ...
                    <map name="retro107">
                        <xsl:apply-templates select="tei:TEI[@xml:id='cartolina107']//tei:facsimile/tei:surface[@xml:id='retro107']"/>
                    </map>
                </div>
                ...
                <div id="quadrato">
                    ...
                    <div id="testoFacs">
                        <div id="testoCartolina">
                            ...
                            <table class="cartolina">
                                <tr>
                                    <td>
                                    <div class="idnoFacs">
                                            <xsl:apply-templates select="tei:TEI[@xml:id='cartolina107']//tei:body//tei:div[@type='codice']"/>
                                        </div> 
                                        
                                        <div id="ruota" class="ruota">  
                                            <xsl:apply-templates select="//tei:text[@xml:id='c107']/tei:body//tei:div[@type='message']"/>
                                        </div>
                                    </td>
                                    <td>
                                        
                                        <xsl:apply-templates select="//tei:text[@xml:id='c107']/tei:body//tei:div[@type='destination']//tei:address"/>
                                    </td>
                                </tr>
                            </table>
                        </div>
                        ...
                        <div id="timbriCartolina">
                            ...
                            <xsl:apply-templates select="//tei:text[@xml:id='c107']/tei:body//tei:div[@type='destination']//tei:stamp"/>
                        </div>
                ...
                <div id="testoCartolinaTypo">
                    ...
                    <div id="testoStampato">
                        <xsl:apply-templates select="//tei:text[@xml:id='c107']/tei:body//tei:div[@type='tipografia']"/>
                    </div>
                </div>
            </body> 
        </html>
    ...
    <xsl:template match="tei:surface[@xml:id='retro107']">
